...
DROP FUNCTION IF EXISTS optimized_codekey_isit(par_codekey t_code_key);
DROP FUNCTION IF EXISTS optimized_acodekey_isit(par_acodekey t_addressed_code_key, par_opt_mask integer);
DROP FUNCTION IF EXISTS optimized_codekeyl_isit(par_codekeyl t_code_key_by_lng, par_opt_mask integer);
DROP FUNCTION IF EXISTS optimized_acodekeyl_isit(par_acodekeyl t_addressed_code_key_by_lng, par_opt_mask integer);
